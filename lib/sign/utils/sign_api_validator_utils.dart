...
class SignApiValidatorUtils {
  static bool isContainedIn({required List<dynamic> container, required List<dynamic> contained}) {
  ...
  static bool isConformingNamespaces({
    ...
    if (!isContainedIn(container: namespaceKeys, contained: requiredNamespaceKeys)) {
      ...
      requiredNamespaceKeys.forEach((key) {
        ...
        // Check the chains, methods and events for overlaps. If any of them don't have it, we fail.
