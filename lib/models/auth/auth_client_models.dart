...
import 'package:wallet_connect/utils/utils.dart';
...
class AuthPublicKey {
  ...
  AuthPublicKey({required this.publicKey});
...
class AuthPayloadParams {
  ...
  factory AuthPayloadParams.fromJson(Map<String, dynamic> json) => _$AuthPayloadParamsFromJson(json);
...
class CacaoPayload extends CacaoRequestPayload {
  ...
  factory CacaoPayload.fromRequestPayload({required String issuer, required CacaoRequestPayload payload}) {
    return CacaoPayload(
      iss: issuer,
...
class PendingAuthRequest {
  ...
  factory PendingAuthRequest.fromJson(Map<String, dynamic> json) => _$PendingAuthRequestFromJson(json);
